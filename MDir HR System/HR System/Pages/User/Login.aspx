...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="row">
          <div class="col-6 col-md-2"></div>
        <div class="col-6 col-md-2"></div>
            <div class="col-6 col-md-2">     <asp:Button style="font-size: unset;" ID="btnLogin" runat="server" Text="ÊÓÌíá ÇáÏÎæá" width="100%" CssClass="btn btn-success" OnClick="btnLogin_Click" /></div>
                <div class="col-6 col-md-2">   <asp:Button style="font-size: unset;" ID="btnCancel" runat="server" Text="ÅáÛÇÁ" width="100%" CssClass="btn btn-danger" OnClick="btnCancel_Click" />
    </div></div>
        <div class="col-6 col-md-2"></div>
     <div class="col-6 col-md-2"></div>
       </div> 
